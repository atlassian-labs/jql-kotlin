...
abstract class AbstractVersionField(name: String) : Field(name), SortableField {
    ...
    infix fun equalTo(function: VersionEqualityFunction): Clause = super.equalTo(function)
    ...
    infix fun notEqualTo(function: VersionEqualityFunction): Clause = super.notEqualTo(function)
    ...
    infix fun anyOf(function: VersionInclusionFunction): Clause = super.anyOf(function)
    ...
    infix fun noneOf(function: VersionInclusionFunction): Clause = super.noneOf(function)

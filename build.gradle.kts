        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    description.set("JQL building Kotlin DSL")
                    url.set("https://github.com/atlassian-labs/jql-kotlin")
                    scm {
                        connection.set("git@github.com:atlassian-labs/jql-kotlin.git")
                        url.set("https://github.com/atlassian-labs/jql-kotlin.git")
                    }
                    developers {
                        developer {
                            id.set("dpenkin")
